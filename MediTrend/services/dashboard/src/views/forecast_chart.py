...
def fetch_forecast_data(
    ...
    if pharmacy_id:
        must_clauses.append({"term": {"pharmacy_id": pharmacy_id}})
...
def render_page():
    ...
    with col2:
        pharmacy_id = st.text_input("약국 ID", placeholder="예: PHARM001")
    ...
    if st.session_state.get("forecast_data_loaded", False):
        with st.spinner("예측 데이터 로딩 중..."):
            data = fetch_forecast_data(
                ...
                pharmacy_id=st.session_state.get("forecast_pharmacy_id"),
