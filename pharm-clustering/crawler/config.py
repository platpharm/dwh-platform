...
class Config:
    ...
    ENDPOINTS = {
        ...
        # 국립중앙의료원 병원 정보
        "hospital_nic": "http://apis.data.go.kr/B552657/HssptlInfoInqireService/getHspitalFullDown",
        # 건강보험심사평가원 병원 정보
        ...
        # 건강보험심사평가원 보건의료 통계
        "health_stat": "http://apis.data.go.kr/B551182/healthStatisticsService/getHealthStatistics",
        # 국토교통부 건축물대장
