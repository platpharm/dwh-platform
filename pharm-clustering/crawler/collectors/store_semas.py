...
if __name__ == "__main__":
    ...
    # 테스트: 특정 행정동 수집 (예: 서울시 강남구 역삼동)
    # test_dong_codes = ["1168010100"]  # 역삼1동 행정동 코드
    # data = collector.collect_by_dong(test_dong_codes, filter_pharmacy=True)
